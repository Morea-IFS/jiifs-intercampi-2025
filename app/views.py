...
def voluntary_register(request):
    ...
    if request.method == 'GET':
        ...
        try:
            ...
            if photo:
                voluntary = Voluntary.objects.create(type_voluntary=type_voluntary, name=name, admin=admin, registration=registration, photo=photo, campus=campus_id)
            else:
                voluntary = Voluntary.objects.create(type_voluntary=type_voluntary, name=name, admin=admin, registration=registration, campus=campus_id)
            voluntary.save()
